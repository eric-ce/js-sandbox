    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
            patterns: [
                ...
                // Add cesium navigation compass styles
                ...
                // Add Tabulator CSS
                { from: path.join(__dirname, 'node_modules/tabulator-tables/dist/css/tabulator_midnight.min.css'), to: 'styles/tabulator_midnight.min.css' },
            ],
        }),

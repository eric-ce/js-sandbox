...
export default class MeasureModeBase {
    ...
    _removeActionByPoint(pointPrimitive, modeString, isClamped = false) {
        ...
        // Proceed only if there are existing groups and the measurement is completed
        if (this.coords.groups.length > 0 && this.flags.isMeasurementComplete) {    // when the measure is completed

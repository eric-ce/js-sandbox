...
function continueMeasure(position) {
    // Remove the moving line and label primitives to prepare for the new measurement
    this.removeMovingPrimitives();

...
class ProfileP {
    ...
    async handleProfileLeftClick(movement) {
        ...
        if (this.coordinateDataCache.length === 0) {
            ...
            if (this.coordinateDataCache.length === 2) {
                ...
                const lineGeometryInstance = createLineGeometryInstance(this.coordinateDataCache, "profile_line", true);
                const linePrimitive = createLinePrimitive(lineGeometryInstance, Cesium.Color.YELLOWGREEN, this.cesiumPkg.Primitive, true);
    ...
    async handleProfileMouseMove(movement) {
        ...
        if (this.coordinateDataCache.length > 0 && this.coordinateDataCache.length < 2) {
            ...
            const movingLineGeometryInstance = createLineGeometryInstance([firstCoordsCartesian, this.coordinate], "profile_moving_line", true);
            const movingLinePrimitive = createLinePrimitive(movingLineGeometryInstance, Cesium.Color.YELLOW, this.cesiumPkg.Primitive, true);
    ...
    async handleProfileDrag(movement, pointPrimitive, pointPrimitivePosition) {
        if (this.isDragMode) {
            ...
            const movingLineGeometryInstance = createLineGeometryInstance([otherPointCoords, this.coordinate], "profile_drag_moving_line", true);
            const movingLinePrimitive = createLinePrimitive(movingLineGeometryInstance, Cesium.Color.YELLOW, this.cesiumPkg.Primitive, true);
    ...
    async handleProfileDragEnd(movement) {
        ...
        if (this.draggingPrimitive && this.isDragMode) {
            ...
            if (linePrimitives.length > 0) {
                ...
                const lineGeometryInstance = createLineGeometryInstance(newCoords, "profile_line", true);
                const newlinePrimitive = createLinePrimitive(lineGeometryInstance, Cesium.Color.YELLOWGREEN, this.cesiumPkg.Primitive, true);
